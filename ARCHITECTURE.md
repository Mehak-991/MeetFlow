# MeetFlow - System Architecture

## Overview

MeetFlow is a **real-time video conferencing platform** built using the **MERN stack** with **WebRTC** for peer-to-peer video communication and **Socket.io** for real-time signaling and messaging.
...
MeetFlow combines **MERN stack architecture**, **WebRTC peer-to-peer streaming**, and **Socket.io real-time communication** to deliver a scalable and responsive video conferencing solution.
