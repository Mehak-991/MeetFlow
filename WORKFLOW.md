# MeetFlow – Application Workflow

## Overview

This document describes the **complete user workflows and system processes** in the MeetFlow video conferencing application.
...
MeetFlow's workflow architecture includes:
...
*Workflow Documentation – MeetFlow Video Conferencing Platform*
