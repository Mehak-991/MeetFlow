...
MeetFlow is a real-time video conferencing application built using a modern MERN stack architecture with WebRTC for peer-to-peer video communication and Socket.io for real-time signaling.
...
│  │                     │  API    │                     │          │
│  │  MeetFlow.onrender   │ Calls   │ MeetFlow-api.render  │          │
│  └─────────────────────┘         └──────────┬──────────┘          │
│                                             │                      │
└─────────────────────────────────────────────┼──────────────────────┘
                                              │
...
_Architecture Document - MeetFlow Video Conferencing Application_
